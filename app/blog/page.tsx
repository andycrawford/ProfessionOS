...
export const metadata: Metadata = {
  title: "Blog — Profession OS",
  description: "Insights, updates, and deep dives from the Profession OS team.",
};
    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        <div className={styles.comingSoon}>
          ...
          <h1 className={styles.title}>Stories coming soon.</h1>
          <p className={styles.subtitle}>
            Product updates, engineering deep dives, and productivity insights from the Profession OS team.<br />
            Sign up to be the first to read.
          </p>
